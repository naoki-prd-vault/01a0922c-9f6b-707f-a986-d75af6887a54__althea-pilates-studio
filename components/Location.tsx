    ...
    <section id="ubicacion" className="py-16 md:py-24 bg-altheaIvory px-4">
      <div className="container mx-auto text-center">
        ...
        <p className="font-sans text-lg md:text-xl text-altheaDeepOlive leading-relaxed mb-10">
          Estamos ubicados en Ciudad Quesada, San Carlos. ¡Te esperamos!
        </p>
        <div className="relative w-full max-w-4xl mx-auto h-96 rounded-xl overflow-hidden shadow-lg mb-10">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3915.65992928374!2d-84.4293963259837!3d10.32386406798083!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8fa064669818817b%3A0x2a91266224346927!2sAlthea%20Pilates%20Studio!5e0!3m2!1sen!2scr!4v1705445778848!5m2!1sen!2scr"
            width="100%"
            height="100%"
            style={{ border: 0 }}
